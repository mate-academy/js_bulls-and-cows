 ...
 */
function bullsAndCows(generatedNumber, enteredNumber = 0) {
  if (enteredNumber.length !== 4 || enteredNumber === 0) {
    return undefined;
  }

  const enterArr = enteredNumber.slice();
  const mySet = new Set(enterArr);
